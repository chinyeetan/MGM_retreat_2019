...
```{r out.width = "95%", fig.align = "center", echo=FALSE, fig.cap = "Oral gavage of _C. immunis_ reduces (A) lethality in DSS colitis, and (B) clinical severity in experimental autoimmune encephalitis. n=5 mice per group (DSS colitis); n=10 mice per group (EAE); *=p<0.05 \\label{figurelabel}"}
...
```{r out.width = "75%", fig.align = "center", echo=FALSE, fig.cap = "(A) _C. immunis_ is localized to the cecum and proximal-mid colon in colonized mice at steady-state (HMb); n=4 mice (B) _C. immunis_ naïve MMb mice do not retain _C. immunis_ beyond 24 hours after single oral gavage; n=9 mice\\label{figurelabel}"}
